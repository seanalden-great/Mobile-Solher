...
//                       // 👇 PERBAIKAN: Deteksi apakah user sedang chat dengan bot AI 👇
//                       // Memecah nama menjadi kata untuk menghindari salah deteksi (e.g. nama "Haidar" atau "Aisyah")
//                       final bool isChattingWithAi = widget.adminName
//                           .toUpperCase()
//                           .split(' ')
//                           .contains('AI');

//                       // Hanya tampilkan animasi JIKA isAiThinking dari BLoC true DAN lawan chatnya adalah AI
//                       final bool showAiThinking =
//                           state.isAiThinking && isChattingWithAi;

//                       return ListView.builder(
//                         controller: _scrollController,
//                         reverse: true,
//                         padding: const EdgeInsets.all(16),
//                         // Gunakan showAiThinking sebagai penentu tambahan item
//                         itemCount:
//                             reversedMessages.length + (showAiThinking ? 1 : 0),
//                         itemBuilder: (context, index) {
//                           if (showAiThinking && index == 0) {
//                             return _buildAiThinkingBubble();
//                           }

//                           // Sesuaikan indeks pesan asli
//                           final msgIndex = showAiThinking ? index - 1 : index;
//                           final msg = reversedMessages[msgIndex];
//                           final isMe = msg.senderId == _myId;
//                           final isAi = msg.sender?['email'] == 'ai@solher.com';
