...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        // Kita membungkus seluruh body dengan 2 BlocBuilder untuk mendapatkan data User dan Address sekaligus
        body: BlocConsumer<AuthBloc, AuthState>(
          listener: (context, state) {
            if (state is AuthActionSuccess) {
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          ...
          builder: (context, authState) {
            ...
            if (authState is AuthLoading && _cachedUser == null) {
              return const Center(
                  child: CircularProgressIndicator(color: Colors.black));
            }
            ...
            if (_cachedUser != null) {
              ...
              return BlocBuilder<AddressBloc, AddressState>(
                ...
                if (addressState is AddressLoaded) {
                  addressCount = addressState.addresses.length;
                }
                ...
                if (firstName.isNotEmpty) score++;
                if (lastName.isNotEmpty) score++;
                ...
                if (user.profileImage != null &&
                    !user.profileImage!.contains('ui-avatars')) {
                  score++;
                } else {
                ...
                if (addressCount > 0) {
                  ...
                  missingFields.add("Alamat Pengiriman");
                }
  ...
  // ==========================================================
  // 👇 WIDGET BARU 1: PROFILE COMPLETENESS (GAMIFIKASI) 👇
  // ==========================================================
  Widget _buildCompletenessBanner(
      double percent, List<String> missing, UserModel user) {
    return Container(
        ...
        children: [
          ...
          RichText(
            text: TextSpan(
              ...
              children: [
                const TextSpan(
                    text:
                        'Dapatkan pengalaman belanja yang lebih cepat. Anda belum melengkapi: '),
                TextSpan(
                  text: missing.join(', '),
                  style: const TextStyle(
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                if (missing.contains('Alamat Pengiriman')) {
                  _showAddressModal(context);
                } else if (missing.contains('Foto Profil')) {
                  _pickImage(context);
                } else {
  ...
  // ==========================================================
  // 👇 WIDGET BARU 2: QUICK ACTION GRID 👇
  // ==========================================================
    ...
    return GridView.count(
      ...
      children: [
        ...
        _buildGridItem(
          ...
          title: 'Solher Club',
          subtitle: 'Klaim Poin Anda',
          color: Colors.purple,
          onTap: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (_) => const SolherClubPage()));
          },
        ),
      ],
    );
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: OutlinedButton(
                      ...
                      onPressed: () => _showEditProfileModal(context, user),
                      child: const Text('Edit Informasi Profil',
                          style: TextStyle(
  ...
  Widget _buildAddressSection(AddressState state) {
    return Container(
      padding: const EdgeInsets.all(24),
      decoration: BoxDecoration(
        color: Colors.white,
